...
// session set kora na thkle login.php te chole jabe
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-5">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="class-all.php">All Classes</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-3">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="">Teachers Payment</a></li>
              </ul>
            </div>
          </li>
